...
int WINAPI WinMain (HINSTANCE hThisInstance,HINSTANCE hPrevInstance,LPSTR lpszArgument,int nCmdShow)
{
    ...
    hwnd = CreateWindowEx (
           ...
           _T("MouseClick By Vmpy"),       /* Title Text */
...
LRESULT CALLBACK WindowProcedure (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    switch (message)
    {
        case WM_CREATE:
        {
            ...
            OkButton = CreateWindowEx(0,"BUTTON","开始(Ctrl+S)",WS_CHILD|WS_VISIBLE|WS_BORDER|BS_PUSHBUTTON|BS_FLAT,410,180,95,35,hwnd,(HMENU)7,0,0);
            EndButton = CreateWindowEx(0,"BUTTON","结束(Ctrl+E)",WS_CHILD|WS_VISIBLE|WS_BORDER|BS_PUSHBUTTON|BS_FLAT,410,245,95,35,hwnd,(HMENU)8,0,0);
